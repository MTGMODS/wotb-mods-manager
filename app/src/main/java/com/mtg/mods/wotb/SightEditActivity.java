...
public class SightEditActivity extends AppCompatActivity {
    ...
    private StorageReference fbs = _firebase_storage.getReference("Mods/Sight");
    ...
    private DatabaseReference fdb = _firebase.getReference("Mods/Sight");
    private ChildEventListener _fdb_child_listener;
    private StorageReference fbs2 = _firebase_storage.getReference("Mods/Sight");
    ...
    private void initialize(Bundle _savedInstanceState) {
        ...
        button5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View _view) {
                ...
                Toast.makeText(SightEditActivity.this, "Мод удалён!", Toast.LENGTH_SHORT).show();
        ...
        _fbs_upload_success_listener = new OnCompleteListener<Uri>() {
            ...
            public void onComplete(Task<Uri> _param1) {
                ...
                fdb.child(position).updateChildren(mapVar);
                _firebase_storage.getReferenceFromUrl(edit_mod.getString("image", "")).delete().addOnSuccessListener(_fbs_delete_success_listener).addOnFailureListener(_fbs_failure_listener);
                Toast.makeText(SightEditActivity.this, "Скриншот заменён!", Toast.LENGTH_SHORT).show();
                mapVar.clear();
            }
        };
        ...
        _fbs2_upload_success_listener = new OnCompleteListener<Uri>() {
            ...
            public void onComplete(Task<Uri> _param1) {
                ...
                fdb.child(position).updateChildren(mapVar);
                _firebase_storage.getReferenceFromUrl(edit_mod.getString("url", "")).delete().addOnSuccessListener(_fbs2_delete_success_listener).addOnFailureListener(_fbs2_failure_listener);
                Toast.makeText(SightEditActivity.this, "Архив заменён!", Toast.LENGTH_SHORT).show();
                mapVar.clear();
            }
        };
    ...
    public void onStart() {
        ...
        }.getIns((int) 80, (int) 5, 0xFFFFFFFF, Color.TRANSPARENT));
    }
