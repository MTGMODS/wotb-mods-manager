...
public class HangarsActivity extends AppCompatActivity {
    ...
    private DatabaseReference fsdb = _firebase.getReference("Mods/Hangars");
    ...
    protected void onCreate(Bundle _savedInstanceState) {
        ...
        setContentView(R.layout.hangars);
        ...
        public View getView(final int _position, View _v, ViewGroup _container) {
            ...
            textview2.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View _view) {
                    FileUtil.writeFile(FileUtil.getExternalStorageDir().concat("/MTG MODS/hangars"), ".");
