...
public class HangarViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hangar_view);
    ...
    public class Listview1Adapter extends BaseAdapter {
        ...
        public View getView(final int _position, View _v, ViewGroup _container) {
            ...
            View _view = _v;
            if (_view == null) {
                _view = _inflater.inflate(R.layout.mod_edit, null);
            }
            ...
            }.getIns((int) 0, (int) 5, 0xFFFFFFFF, Color.TRANSPARENT));
            ...
            button1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View _view) {
                    ...
                    i.setClass(getApplicationContext(), HangarEditModActivity.class);
                    startActivity(i);
