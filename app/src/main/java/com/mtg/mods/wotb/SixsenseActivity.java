...
public class SixsenseActivity extends AppCompatActivity {
	...
	private DatabaseReference fsdb = _firebase.getReference("Mods/SixSense");
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.sixsense);
